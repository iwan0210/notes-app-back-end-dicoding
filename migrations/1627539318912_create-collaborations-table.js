...
exports.up = pgm => {
    ...
    */
    pgm.addConstraint('collaborations', 'unique_note_id_user_id', 'UNIQUE(note_id, user_id)')
    ...
    pgm.addConstraint('collaborations', 'fk_collaborations.note_id_users.id', 'FOREIGN KEY(user_id) REFERENCES users(id) ON DELETE CASCADE')
}
